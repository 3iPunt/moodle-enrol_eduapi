...
$string['settings_multilang'] = 'Υποστήριξη πολυγλωσσίας';
$string['settings_multilang_desc'] = 'Όταν ενεργοποιείται, τα πλήρη ονόματα μαθημάτων, τα ονόματα ομάδων και η περίληψη του μαθήματος (δείτε τη ρύθμιση "Συγχρονισμός περιγραφής ως περίληψης") κατασκευάζονται από όλες τις διαθέσιμες γλώσσες, τυλίγοντας κάθε recordLanguage του Edu-API σε μια ετικέτα `<span lang="..." class="multilang">...</span>`. Για να εμφανιστεί αυτό το markup ως ξεχωριστές γλώσσες απαιτείται να είναι ενεργοποιημένο το φίλτρο "Περιεχόμενο πολλών γλωσσών" (filter/multilang) του ιστότοπου· διαφορετικά εμφανίζονται τα ακατέργαστα spans. Όταν είναι απενεργοποιημένο (προεπιλογή), επιλέγεται μία μόνο τιμή: αυτή που ταιριάζει με την προεπιλεγμένη γλώσσα του ιστότοπου, αλλιώς τα αγγλικά, αλλιώς η πρώτη διαθέσιμη.';
...
$string['settings_sync_description'] = 'Συγχρονισμός περιγραφής ως περίληψης';
$string['settings_sync_description_desc'] = 'Αντιγράφει την περιγραφή του offering στην περίληψη του μαθήματος Moodle σε κάθε συγχρονισμό, διατηρώντας τις αλλαγές γραμμής του παρόχου. Όταν απενεργοποιείται, η περίληψη του μαθήματος δεν γράφεται ποτέ από τον συγχρονισμό. Ένα offering χωρίς περιγραφή δεν διαγράφει ποτέ μια υπάρχουσα περίληψη μαθήματος.';
