...
/**
 * Generic Edu-API Exception.
 *
 * Edu-API's ServiceDefinitions package defines the same IMSx status info
 * model (Imsx_StatusInfo/Imsx_CodeMajor/Imsx_Severity) used by 1EdTech
 * OneRoster, so the resource-endpoint error hierarchy is ported unchanged
 * from enrol_oneroster (namespace and messages adapted only).
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class exception extends base_exception {
    ...
    protected static function create_from_http_response(
        ...
        switch ($info['http_code']) {
            ...
            case 403:
                // Forbidden - the server can be reached and process the request but refuses to take any
                // further action.
