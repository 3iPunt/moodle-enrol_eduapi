...
/**
 * Edu-API v1p0 Organizations collection.
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class organizations extends collection {
    ...
    protected static function get_operation_id(container_interface $container): string {
        return organization_management::getAllOrganizations;
    }
    ...
    protected static function parse_returned_row(container_interface $container, stdClass $data): entity {
        return $container->get_entity_factory()->get_organization_from_result($data);
    }
}
