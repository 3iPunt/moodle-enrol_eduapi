...
/**
 * Edu-API v1p0 CollectionOfferings collection.
 *
 * Not consumed by any converter in this plugin and unverified against the development mock provider —
 * see classes/local/v1p0/entities/collection_offering.php's note.
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class collection_offerings extends collection {
    ...
    protected static function get_operation_id(container_interface $container): string {
        return education_management::getAllCollectionOfferings;
    }
    ...
    protected static function parse_returned_row(container_interface $container, stdClass $data): entity {
        return $container->get_entity_factory()->get_collection_offering_from_result($data);
    }
}
