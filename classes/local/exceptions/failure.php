...
/**
 * IMSx Failure Exception.
 *
 * Represents an error reported through the IMSx status info payload
 * (`Imsx_StatusInfo` in the Edu-API ServiceDefinitions package) rather than
 * through a plain HTTP status code.
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
