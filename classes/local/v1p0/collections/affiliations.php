...
/**
 * Edu-API v1p0 Affiliations collection.
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class affiliations extends collection {
    ...
    protected static function get_operation_id(container_interface $container): string {
        return affiliation_management::getAllAffiliations;
    }
    ...
    protected static function parse_returned_row(container_interface $container, stdClass $data): entity {
        return $container->get_entity_factory()->get_affiliation_from_result($data);
    }
}
