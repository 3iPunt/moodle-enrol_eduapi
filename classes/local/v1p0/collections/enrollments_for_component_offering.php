...
/**
 * Edu-API v1p0 Enrollments-for-a-ComponentOffering collection.
 *
 * Reuses enrollments.php's endpoint and row-parsing, overriding only the operation id. Constructed
 * with params `[':id' => $componentofferingid]` (see classes/local/factories/collection_factory.php).
 *
 * @package    enrol_eduapi
 * @copyright  2026 3iPunt (contacte@tresipunt.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class enrollments_for_component_offering extends enrollments {
    ...
    protected static function get_operation_id(container_interface $container): string {
        return enrollment_management::getAllEnrollmentsForComponentOffering;
    }
}
