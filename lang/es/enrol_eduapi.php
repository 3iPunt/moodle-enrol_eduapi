...
$string['settings_user_field_source_desc'] = 'Opcional. El atributo de la Person que se copia en el campo "{$a}" del usuario de Moodle: `extensions.<key>` lee el valor de primer nivel `extensions.<key>`, o `otherIdentifiers.<identifierType>` lee el identifier de la primera entrada de `otherIdentifiers` de ese tipo. Déjelo vacío para desactivarlo. Un atributo ausente o vacío deja el campo intacto: la sincronización nunca lo vacía. Que el campo también se mantenga actualizado en los usuarios existentes en cada sincronización depende del ajuste "Actualizar los campos de los usuarios existentes" de más abajo.';
