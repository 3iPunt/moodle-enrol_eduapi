...
$string['settings_datasync_academic_session_desc'] = 'Η μοναδική ακαδημαϊκή περίοδος προς συγχρονισμό. Συμπληρώνεται από το «Έλεγχος σύνδεσης» παραπάνω.';
...
$string['settings_sync_groups_desc'] = 'Δημιουργία ομάδας Moodle για κάθε προσφορά στο επίπεδο που δεν επιλέχθηκε ως μάθημα (π.χ. ComponentOfferings, όταν το CourseOffering είναι το επίπεδο μαθήματος).';
...
$string['settings_user_match_source_desc'] = 'Το χαρακτηριστικό του προσώπου (Person) που αντιστοιχίζεται με το παραπάνω πεδίο Moodle.';
