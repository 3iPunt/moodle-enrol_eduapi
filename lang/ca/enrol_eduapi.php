...
$string['settings_user_field_source_desc'] = 'Opcional. L\'atribut de la Person que es copia al camp "{$a}" de l\'usuari de Moodle: `extensions.<key>` llegeix el valor de primer nivell `extensions.<key>`, o `otherIdentifiers.<identifierType>` llegeix l\'identifier de la primera entrada d\'`otherIdentifiers` d\'aquest tipus. Deixeu-lo buit per desactivar-ho. Un atribut absent o buit deixa el camp intacte: la sincronització no l\'esborra mai. Que el camp també es mantingui actualitzat en els usuaris existents a cada sincronització depèn de l\'ajust "Actualitza els camps dels usuaris existents" de més avall.';
